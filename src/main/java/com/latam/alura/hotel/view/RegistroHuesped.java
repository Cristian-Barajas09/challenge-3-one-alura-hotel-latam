...
public class RegistroHuesped extends JFrame {
    ...
    public RegistroHuesped() {
        ...
        txtFechaN.getCalendarButton().setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/icon-reservas.png"))));
        ...
        btnguardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(
                        nombre.isBlank() || apellido.isBlank() || nacionalidad.isBlank() || telefono.isBlank()
                ){
                ...
                if(Objects.equals(nombre, "Beltz")){
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "el numero de telefono no debe contener letras" );
                    return;
                }
        ...
        imagenFondo.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/registro.png"))));

        JLabel logo = new JLabel("");
        logo.setBounds(194, 39, 104, 107);
        panel.add(logo);
        logo.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/Ha-100px.png"))));
