...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        imagenFondo.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/reservas-img-3.png"))));
        ...
        txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/icon-reservas.png"))));
