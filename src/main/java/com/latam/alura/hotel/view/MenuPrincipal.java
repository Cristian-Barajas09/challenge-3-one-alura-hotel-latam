...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        ...
        Icon imgFondo = new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/menu-img.png")));

        imagenFondo.setIcon(imgFondo);
        panel.add(imagenFondo);

        JLabel logo = new JLabel("");
        logo.setBounds(722, 80, 150, 156);

        logo.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/aH-150px.png"))));
        panel.add(logo);
        ...
        imagenLogin.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/login.png"))));
