...
public class MenuPerfil extends JFrame{
    ...
    private SessionController sessionControler;

    public MenuPerfil(Usuario usuario) {
...
;
    ...
    private void update() {
            ...
            if(
                    (usuario.equals("Ingrese su nombre de usuario") || nombre.equals("Ingrese su nombre") || apellido.equals("Ingrese su apellido")) ||
